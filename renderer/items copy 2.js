...
exports.addItem = (item, isNew = false) => {
	...
	// const HTML = `
  //   <div class="read-item" data-url="${item.url}">
  ...
  // `
	...
	items.firstElementChild.addEventListener('click', this.select)

	// Attach doubleclick handler to open
	items.firstElementChild.addEventListener('dblclick', this.open)

	// If this is the first item, select it
	if (document.getElementsByClassName('read-item').length === 1) {
		items.firstElementChild.classList.add('selected')
	}
